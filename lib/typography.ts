/** Luxury type roles — light serif display, refined sans for UI and labels */

export const typeEyebrowLight =
  "font-sans text-[11px] font-normal uppercase tracking-[0.28em] text-loire-blue-mid sm:text-xs";

export const typeEyebrowDark =
  "font-sans text-[11px] font-normal uppercase tracking-[0.28em] text-white/80 sm:text-xs";

/** Large editorial headlines */
export const typeDisplayLight =
  "font-display text-3xl font-medium leading-[1.08] tracking-[-0.02em] text-loire-blue-deep sm:text-4xl lg:text-5xl";

export const typeDisplayDark =
  "font-display text-3xl font-medium leading-[1.08] tracking-[-0.02em] text-white sm:text-4xl lg:text-5xl";

/** Hero and oversized display */
...
export const typeBodyMutedLight =
  "font-sans text-base font-light leading-relaxed text-loire-blue sm:text-lg";

export const typeBodyDark =
  "font-sans text-base font-light leading-relaxed text-white/95 sm:text-lg";

export const typeBodyMutedDark =
  "font-sans text-base font-light leading-relaxed text-white/80 sm:text-lg";

export const typeCaptionDark =
  "font-sans text-sm font-light leading-relaxed text-white/75 sm:text-base";
...
/** Nav / CTA — refined caps, not heavy bold */
export const typeNavLink =
  "font-sans text-[11px] font-normal uppercase tracking-[0.2em]";
